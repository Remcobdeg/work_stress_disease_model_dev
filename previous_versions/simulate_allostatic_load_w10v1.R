...
#model fit by R2
R2.hl<-logChi/odds_model$null.deviance
R.cs<-1-exp((odds_model$deviance-odds_model$null.deviance)/nrow(data.day))
R.n<-R.cs/(1-(exp(-(odds_model$null.deviance/nrow(data.day)))))
R2.hl; R.cs; R.n
