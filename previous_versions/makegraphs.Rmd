...
#determine ratio of people having developed allostatic load during the simulation
simlog$loadratio <- sum(daydata$Aload[which(daydata$days==paste0("day",settings$days))]>rep(0,settings$people))/settings$people

```

```{r, echo = FALSE, warning = FALSE}
simlog$rendertime <- Sys.time()-start.time
```


```{r}
#display settings and simlog
settings
simlog
```
