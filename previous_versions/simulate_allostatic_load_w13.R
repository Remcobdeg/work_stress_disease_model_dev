...
if (save_settings == T){
  ...
  file = paste("simpopulation", format(Sys.time(),"%Y-%m-%d_%H-%M"),".csv", sep="_")
  write.csv(simpopulation, file)
  file = paste("data.day", format(Sys.time(),"%Y-%m-%d_%H-%M"),".csv", sep="_")
  write.csv(data.day, file)
  file = paste("plotdata", format(Sys.time(),"%Y-%m-%d_%H-%M"),".csv", sep="_")
  write.csv(plotdata, file)
  file = paste("Qdata", format(Sys.time(),"%Y-%m-%d_%H-%M"),".csv", sep="_")
  write.csv(Qdata, file)
}
